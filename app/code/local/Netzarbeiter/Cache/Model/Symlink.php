...
class Netzarbeiter_Cache_Model_Symlink extends Zend_Cache_Backend_File
{
	 ...
	 * This method is only overridden for testing and debugging purposes.
	 *
	 * @param param  string $id cache id
     * @return boolean true if no problem
	 */
	public function remove($id)
	{
		Mage::log('Removing ' . $id, Zend_Log::DEBUG, 'cache.log');
	...
	protected function _get($dir, $mode, $tags = array())
    {
		...
		if ('matchingAny' === $mode) {
			...
			$glob = $this->_getFilesMathingAllTags($tags);
	 ...
	 * @return array
	 */
	protected function _getFilesMathingAllTags(array $tags)
	{
		$files = array();
		$prefix = $this->_options['file_name_prefix'];
